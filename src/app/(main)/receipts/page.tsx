      ...
      >
        {selectedReceipt && (
          <div className="space-y-4 pt-1 pb-4 text-xs">
            {/* Certificate Card */}
            <div className="p-4 rounded-xl bg-surface border border-border-light shadow-sm space-y-3">
              <div className="flex items-center justify-between border-b border-border-light pb-2.5">
                ...
                <div className="w-8 h-8 rounded-xl bg-background text-foreground flex items-center justify-center">
                  <ShieldCheck className="w-4 h-4" />
                </div>
              </div>

              {/* Amount Highlight */}
              <div className="rounded-lg bg-background p-3 border border-border-light flex items-center justify-between">
                <div>
              ...
              {/* Property Details */}
              <div className="border-t border-border-light pt-2 space-y-0.5 text-xs">
              ...
              {/* Authentication Note */}
              <div className="p-2.5 rounded-lg bg-background border border-border-light text-[11px] text-on-surface-muted">
